...
class MqttService {
  ...
  constructor() {
    const clientId = "MqttTutorial2";

   //this.client = new Paho.MQTT.Client("192.168.0.27", 1813, clientId);
    this.client = new Paho.MQTT.Client("192.168.15.10", 3000, clientId);
